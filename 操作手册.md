...
​	 **CUDA和pytorch版本号为强对应关系，不要随意升级降级pytorch，会导致cuda出现问题从而导致Gpu训练出现问题**。

​	**在训练yolo的时候，如果发现显存占用为0，那么就是在用Cpu进行训练，说明环境出问题了。**	

------

  4.**yaml文件**：数据集文件以及yolo的网络结构文件为yaml文件类型，pycharm中显示为红色。

​	yolov11以及yolo其他版本的网络结构yaml文件放在项目结构中的    **ultralytics-main/ultralytics/cfg/models/** 文件夹下。

​	公开数据集的配置文件放在**ultralytics-main/ultralytics/cfg/datasets**文件夹下。

​	**自己的数据集我记得我好像将配置文件写在了项目结构的根目录下，名字叫my_data.yaml还是dataset.yaml来着我忘了。**
...
![image-20241110163818564](C:\Users\dusty\AppData\Roaming\Typora\typora-user-images\image-20241110163818564.png)
...
![image-20241110170610910](C:\Users\dusty\AppData\Roaming\Typora\typora-user-images\image-20241110170610910.png)

（2）训练预加载时候可以查看目前采用的网络的模型结构

![image-20241110170735964](C:\Users\dusty\AppData\Roaming\Typora\typora-user-images\image-20241110170735964.png)
...
​		![image-20241110171017006](C:\Users\dusty\AppData\Roaming\Typora\typora-user-images\image-20241110171017006.png)
...
![image-20241110171906561](C:\Users\dusty\AppData\Roaming\Typora\typora-user-images\image-20241110171906561.png)



（2）**训练结束后，会计算得到总体的map值以及数据集中每个类别的map值**，**parameters为训练过程中的参数量，这个数据在模型对比中的论文中也常常拿来进行对比（可以体现模型是否足够轻量化）。**

![image-20241110172031333](C:\Users\dusty\AppData\Roaming\Typora\typora-user-images\image-20241110172031333.png)
...
![image-20241110172825298](C:\Users\dusty\AppData\Roaming\Typora\typora-user-images\image-20241110172825298.png)



<img src="F:\2\2.jpg" alt="2" style="zoom:10%;" />
...
![image-20241110174620825](C:\Users\dusty\AppData\Roaming\Typora\typora-user-images\image-20241110174620825.png)
...
<img src="https://i0.hdslb.com/bfs/article/842a0ec4a4035d17d83aab812d9690c765a03f34.jpg" alt="img" style="zoom:25%;" />
